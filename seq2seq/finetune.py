...
from seq2seq.lightning_base import BaseTransformer, add_generic_args, generic_train
...
class SummarizationModule(BaseTransformer):
    ...
    def _generative_step(self, batch: dict) -> dict:
        ...
        generated_ids = self.model.generate(
            ...
            min_length=0,
            max_length=self.hparams.test_max_target_length,
            num_beams=self.hparams.beam_size,
            no_repeat_ngram_size=self.hparams.ngram_size,
