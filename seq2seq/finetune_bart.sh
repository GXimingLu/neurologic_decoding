...
OUTPUT_DIR_NAME='finetune_model/bart-large'
CURRENT_DIR=${PWD}
...
CUDA_VISIBLE_DEVICES=5 python finetune.py --num_workers 16 \
  --data_dir ${DATA_DIR} --output_dir=${OUTPUT_DIR} \
  --model_name_or_path facebook/bart-large --cache_dir ${CACHE_DIR} \
