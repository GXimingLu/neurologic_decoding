...
from s2s_lm.s2s_ft.modeling import BertForSequenceToSequence
from transformers import AdamW, get_linear_schedule_with_warmup
from transformers import \
    RobertaConfig, BertConfig, \
    BertTokenizer, RobertaTokenizer, \
    XLMRobertaConfig, XLMRobertaTokenizer
from s2s_lm.s2s_ft.configuration_unilm import UnilmConfig
from s2s_lm.s2s_ft.tokenization_unilm import UnilmTokenizer
from s2s_lm.s2s_ft.configuration_minilm import MinilmConfig
from s2s_lm.s2s_ft.tokenization_minilm import MinilmTokenizer

from s2s_lm.s2s_ft import utils
from s2s_lm.s2s_ft.config import BertForSeq2SeqConfig
...
def train(args, training_features, model, tokenizer):
    ...
    if args.num_warmup_steps == 0:
        args.num_warmup_steps = int(args.warmup_proportion * args.num_training_steps)
